...
title('Relative VWF extension')

    plot(sch(:,1),(sch(:,2)-1)/max(sch(:,2)-1,[],'all'),'b.','MarkerSize',10)
...
legend('VWF model','Lippok et al.','Schneider et al.','$5,096s^{-1}$','Interpreter','latex','Location','northwest')
